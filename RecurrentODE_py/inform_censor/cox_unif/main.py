"""Driver for the uniform-censoring Cox recurrent-event simulation.

Identical fit/inference code as ``RecurrentODE_py.cox.main`` -- only the
data generator is swapped to ``inform_censor.cox_unif.generator_rec``,
