"""Port of ltm/objective_func.m (Cox-type objective used by cox_rec)."""
...
def objective_func(r, x, time, delta, p, q, knots, k):
    ...
    # accepts ties); deduplicate, integrate, then expand back via bin_idx.
